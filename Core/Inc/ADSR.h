...
typedef struct
{
	...
	int triggered; //mijenja  je trigger() funkcija u funkciji HAL_UART_RxCpltCallback() u main.c
	int released; //mijenja je release() funkcija u funkciji HAL_UART_RxCpltCallback() u main.c

}ADSR;

extern ADSR adsr; //mora se tako definirati da bi bila dostupna u main.c
